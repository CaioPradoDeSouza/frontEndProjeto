...
const PerfilUsuario = () => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Gerenciamento de Perfis de Usuários</h5>
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={perfilUsuarioDialog} style={{ width: '450px' }} header="Detalhes do perfil de usuário" modal className="p-fluid" footer={perfilUsuarioDialogFooter} onHide={hideDialog}>
                        <div className="field">
                    ...
                    <Dialog visible={deletePerfilUsuarioDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deletePerfilUsuarioDialogFooter} onHide={hideDeletePerfilUsuarioDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {perfilUsuario && (
                                <span>
                                    Você realmente deseja excluir o perfil de usuario? <b>{perfilUsuario.id}</b>?
                                </span>
                            )}
                        </div>
                    </Dialog>
                    ...
                    <Dialog visible={deletePerfisUsuarioDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deletePerfisUsuarioDialogFooter} onHide={hideDeletePerfisUsuarioDialog}>
                        <div className="flex align-items-center justify-content-center">
                            <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                            {perfilUsuario && <span>Você realmente deseja excluir os perfis de usuário?</span>}
                        </div>
                    </Dialog>
                </div>
            </div>
